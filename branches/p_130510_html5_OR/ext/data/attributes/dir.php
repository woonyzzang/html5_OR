...
<article id="content_desc">
	...
	<section>
		...
		<div id="gridAttr"></div>
		<p>auto 키워드인 경우 양방향 알고리즘에서 문단 레벨로 방향성을 결정하는 것과 흡사하게, 첫 문자만을 보고 판단합니다. 때문에 방향성을 제대로 알 수 없습니다. 서버쪽에서 사용할 수 있는 더 좋은 알고리즘이 없는 경우에만 사용하기를 권장합니다.</p>
		<p>dir 속성의 기본값은 없습니다. (요소가 루트 요소이고, dir 속성이 정의되지 않았을 때 요소의 방향성은 ltr 상태가 됩니다.)</p>
		<p>부모 요소를 갖는 요소에 dir 속성이 없다면, 부모의 방향성을 따릅니다.</p>
	</section>
	<!-- //태그 설명 -->
	<!-- 메모 -->
	<section>
