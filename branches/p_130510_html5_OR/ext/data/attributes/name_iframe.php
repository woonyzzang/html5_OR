...
<head>
<meta charset="utf-8">
<title>name 속성 (iframe) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 태그 설명 -->
	<section>
		<h2 class="s_tit">name 속성 (iframe)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>name 속성은 iframe 요소에 사용된 중첩된 문맥의 이름을 나타냅니다.</dd>
		</dl>

		<h3 class="s_tit">속성 값</h3>
		<p>유효한 문맥 이름이어야 합니다.</p>
	</section>
	<!-- //태그 설명 -->
	<!-- 샘플 코드 -->
	<section>
		...
		<pre class="brush:html">
			<iframe src="ad.html" name="ad"></iframe>
		</pre>
	</section>
	<!-- //샘플 코드 -->
	<!-- 참고 -->
