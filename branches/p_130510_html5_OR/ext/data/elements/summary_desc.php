...
<head>
<meta charset="utf-8">
<title>summary 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Use HTMLElement.
	...
	<section id="flow">
		...
		<ul>
		<li>details 요소의 자식 요소로 사용됩니다.</li>
		<li>자식 요소로 하나의 구문 콘텐츠를 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>summary 요소는 details 요소의 제목 표시를 정의합니다.</li>
		<li>제목은 세부 정보를 보려면 &frasl; 숨기려면 클릭 할 수 있습니다.</li>
		<li>IE, FF, Opera 에서 summary 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
