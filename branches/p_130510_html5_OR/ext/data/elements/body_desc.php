...
<head>
<meta charset="utf-8">
<title>body 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLBodyElement : HTMLElement {
	...
	<section id="flow">
		...
		<ul>
		<li>섹션루트에 속합니다.</li>
		<li>html 요소 내의 두 번째 요소에 사용할 수 있습니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>HTML5에서는 레이아웃 관련 alink 속성, background 속성, bgcolor 속성, link 속성, text 속성, vlink 속성은 폐기된 속성입니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
