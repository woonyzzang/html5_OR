...
<head>
<meta charset="utf-8">
<title>input 요소 : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 태그 설명 -->
	<section>
		<h2 class="s_tit">input 요소: (input control)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>input 요소는 타입을 갖는 데이터 필드입니다. 이 요소는 타입(속성)을 지정하여 옵션을 넣으면 한 줄 글상자, 확인 상자, 라디오 버튼, 입력버튼, 그림 등의 다양한 방법으로 설정할 수 있습니다.</dd>
		</dl>
