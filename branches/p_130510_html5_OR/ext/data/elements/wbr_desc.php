...
<head>
<meta charset="utf-8">
<title>wbr 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<li>&#34;&#38;#8203;&#34;, &#34;&#38;shy;&#34;와 같은 엔티티 문자열로 대체하여 사용할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>HTML5에서 추가된 요소입니다. 하지만 이전에도 IE, Firefox, Konqueror 등에서 제공되어 사용할 수 있었습니다.</li>
		<li>한글이나 일어와 같은 2byte 문자열은 처리하지 못합니다.</li>
		<li>IE6~10 버전, wbr 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
