...
<head>
<meta charset="utf-8">
<title>param 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>object 요소의 자손으로. 이 요소 앞에 플로우 컨텐츠가 올 수 없습니다.</dd>
...
interface HTMLParamElement : HTMLElement {
	...
	<section id="flow">
		...
		<ul>
		<li>object 요소의 자손 요소로 사용 되지만, param 요소 앞에 플로우 컨텐츠가 올 수 없습니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>type 속성, valuetype 속성은 폐기된 속성입니다.</li>
		<li>이 요소에 정의 된 파일 형식은 모든 브라우저에서 지원되지 않을 수 있습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
