...
<head>
<meta charset="utf-8">
<title>hr 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLHRElement : HTMLElement {};
	...
	<section id="memo">
		...
		<ul>
		<li>hr 요소는 그동안 시각적으로 수평선을 그리는데 주로 사용됐지만, HTML5에서는 주제를 분리하는 의미를 갖게 되었습니다.</li>
		<li>스크린리더와 같은 보조기기가 hr 요소를 만나면 문단과 문단 사이에서의 멈춤보다 좀 더 긴 멈춤 상태를 유지게 지원할 수도 있을 것입니다.</li>
		<li>align, noshade, size, width 속성은 사용되지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
