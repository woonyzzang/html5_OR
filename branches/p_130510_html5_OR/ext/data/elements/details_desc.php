...
<head>
<meta charset="utf-8">
<title>details 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>하나의 summary 요소. 그 뒤에 플로우 컨텐츠가 옵니다.</dd>
...
interface HTMLDetailsElement : HTMLElement {
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠, 섹션 컨텐츠, 대화형 컨텐츠에 속합니다.</li>
		<li>플로우 컨텐츠의 위치에 올 수 있습니다.</li>
		<li>자식 요소로 하나의 summary 요소를 포함할 수 있고 그 뒤에 플로우 컨텐츠를 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>summary 요소는 세부 사항에 대한 표시 제목을 지정하는 역할을 하며, 제목은 세부정보 보기&frasl;숨기기를 클릭 할 수 있습니다.</li>
		<li>open 속성이 설정되어 있지 않으면 details 요소의 내용이 표시되지 안됩니다.</li>
		<li>IE, Firefox, Opera에서 details 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
