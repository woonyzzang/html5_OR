...
<head>
<meta charset="utf-8">
<title>p 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLParagraphElement : HTMLElement {};
	...
	<section id="flow">
		...
		<li>p 요소보다 더 나은 요소가 있다면 그것을 사용하는 것이 좋습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>HTML 4.01에서는 자신(p 요소)을 포함한 문단 요소를 포함할 수 없다는 정의를 포함하고 있습니다. HTML5에서는 이같은 설명은 생략되었지만, 여전히 유효합니다. HTML5에서는 p 요소가 구문 컨텐츠를 자식 요소로 포함할 수 있다고 정의하고 있는데, 구문 컨텐츠에는 p 요소 div 요소를 포함하고 있지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
