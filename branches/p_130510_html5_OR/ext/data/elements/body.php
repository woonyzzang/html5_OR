...
<head>
<meta charset="utf-8">
<title>body 요소 : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	...
	<section>
		<div>
		<h2 class="s_tit">body 요소: (document body)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>body 요소는 문서 내 영역을 정의하는 요소로, 글자, 이동(하이퍼링크), 이미지, 테이블, 목록 등, 웹 브라우저에 표시할 HTML 문서의 주된 콘텐츠를 나타냅니다.</dd>
		</dl>
