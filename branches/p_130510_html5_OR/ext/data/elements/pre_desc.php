...
<head>
<meta charset="utf-8">
<title>pre 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLPreElement : HTMLElement {};
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠, formatBlock이 될 수 있는 요소에 속합니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>아스키 그림을 pre 요소로 다룬 경우와 같이 스크린 리더나 점자 출력기가 처리하기 곤란한 경우를 위해 대체 텍스트를 제공하면 좋습니다.</li>
		<li>pre 요소에서 width 속성은 사용할 수 없습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
