...
<head>
<meta charset="utf-8">
<title>textarea 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLTextAreaElement : HTMLElement {
  ...
  void setSelectionRange(in unsigned long start, in unsigned long end);
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠, 구문 컨텐츠, 대화형 컨텐츠 목록화된 레이블을 붙일 수 있는, 제출할 수 있는, 리셋할 수 있는 폼 관련 요소에 속합니다.</li>
		<li>구문 컨텐츠가 올 수 있는 곳에 사용될 수 있습니다.</li>
		<li>텍스트를 자식 요소로 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>텍스트 영역의 문자를 무제한으로 저장할 수 있습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
