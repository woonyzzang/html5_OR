...
<head>
<meta charset="utf-8">
<title>meter 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>
			...
			<li>플로우 컨텐츠</li>
			<li>구문 컨텐츠</li>
			<li>레이블을 붙일 수 있는 폼 관련 요소</li>
			</ul>
		</dd>
		<dt>[이 사용될 수 있는요소가 문맥]</dt>
		<dd>구문 컨텐츠가 사용될 수 있는 곳</dd>
		<dt>[이 요소가 포함할 수 있는 것]</dt>
		<dd>구문 컨텐츠. 하지만 meter 요소를 자손으로 가질 수는 없습니다.</dd>
		<dd>또는, 플로우 컨텐츠</dd>
...
interface HTMLMeterElement : HTMLElement {
  ...
  readonly attribute NodeList labels;
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠, 구문 컨텐츠, 레이블을 붙일 수 있는 폼 관련 요소에 속합니다.</li>
		<li>구문 컨텐츠의 위치에 사용할 수 있습니다.</li>
		<li>자식 요소로 구문 컨텐츠를 포함할 수 있지만 meter 요소를 자손으로 가질 수 없습니다.</li>
		<li>meter 요소를 지원하지 않는 사용자 에이전트를 쓰는 사람을 위해 게이지의 상태를 텍스트로도 나타낼 것을 권장합니다.</li>
		<li>meter 요소에서 명시적으로 단위를 나타낼 방법은 없습니다. title 속성에 단위를 텍스트로 특별한 형식 없이 기록해도 무방합니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>IE6~10 버전, meter 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
