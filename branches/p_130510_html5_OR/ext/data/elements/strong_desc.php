...
<head>
<meta charset="utf-8">
<title>strong 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="memo">
		...
		<ul>
		<li>기본적으로 모든 브라우저에 bold체로 렌더링 됩니다.</li>
		<li>strong 요소와 em 요소, strong 요소와 b 요소를 혼동하지 마십시오. strong 요소는 객관적인 중요성을 나타내지만 em 요소는 저자가 주관적으로 강조하고자 하는 내용입니다. b 요소는 중요함이나 강조와는 상관 없이 통상 볼드체로 표현하곤 하는 내용을 나타내는 표현적 요소입니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
