...
<head>
<meta charset="utf-8">
<title>embed 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLEmbedElement : HTMLElement {
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠, 섹션 컨텐츠, 포함된 컨텐츠, 대화형 컨텐츠에 속합니다.</li>
		<li>포함된 컨텐츠가 올 수 있는 곳에서 사용될 수 있습니다.</li>
	...
	<section id="memo">
		...
		<li>이전에는 object 요소를 지원하지 않는 특정 브라우저를 위해 사용되었던 요소였지만, 표준 요소로 지정되어 최신 브라우저에서 정식으로 사용할 수 있게 되었습니다.</li>
		<li>em 요소는 기울임꼴 요소가 아닙니다. 글쓴이의 주장을 강조하는데 씁니다. 글의 일부분을 기울임꼴로 표현하려 할 때는 i 요소가 좀 더 적합합니다.</li>
		<li>폐기된 속성인 name 속성, align 속성, hspace 속성, vspace 속성을 제외한 모든 네임스페이스 없는 속성을 사용할 수 있습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
