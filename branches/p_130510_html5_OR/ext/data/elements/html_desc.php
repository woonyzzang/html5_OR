...
<head>
<meta charset="utf-8">
<title>html 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>문서의 루트 요소</dd>
		<dd>복합 문서에서 서브문서가 허용되는 곳</dd>
		<dt>[이 요소가 포함할 수 있는 것]</dt>
		<dd>head 요소와, 그 뒤에 있는 body 요소</dd>
...
interface HTMLHtmlElement : HTMLElement {};
	...
	<section id="flow">
		...
		<ul>
		<li>문서의 기본 요소입니다.</li>
		<li>head 요소와 body 요소를 포함할 수 있습니다.</li>
		<li>lang 속성으로 내용에서 사용할 언어를 지정할 수 있습니다.</li>
		<li>html 요소가 마크업 어디에도 없다고 하더라도, html 요소는 항상 기본 html 요소를 가집니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>manifest 속성은 HTML5에서 추가된 속성입니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
