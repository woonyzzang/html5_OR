...
<head>
<meta charset="utf-8">
<title>s 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<ul>
		<li>s 요소는 구문 컨텐츠와 구문 컨텐츠에 속합니다.</li>
		<li>s 요소는 구문 컨텐츠의 위치에 사용할 수 있습니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>이 요소는 표현적인 성격이 강해서 HTML4&frasl;XHTML1 명세에서는 폐기했었지만, 이미 널리 쓰이고 있는 것이므로 적합한 의미를 주어서 HTML5 명세에서 부활시켰습니다.</li>
		<li>s 요소는 del 요소와는 다릅니다. 브라우저 기본 스타일시트에서 두 요소의 표현이 똑같다 해서 의미를 혼동해서는 안 됩니다. del 요소는 통상 공동 작업하는 문서에서 일부 내용을 삭제했음을 나타내는 데 사용합니다. s 요소는 삭제된 내용이 아니라 &#34;지금은 이렇지 않다&#34;는 의미를 전달합니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
