...
<head>
<meta charset="utf-8">
<title>pattern 속성 (input) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	...
	<section>
		...
		<dl class="definition">
		<dt>정의</dt>
		<dd>pattern 속성은 컨트롤의 값이 통과해야 할 정규 표현식을 명시하며 multiple 속성이 사용된 경우 콘트롤의 값을 확인합니다.</dd>
		<dd>input 요소에 pattern 속성을 사용 하였다면, 반드시 title 속성을 사용해서 패턴에 대한 설명을 제공해야 합니다. 사용자 에이전트는 title 속성의 내용을 활용해서, 패턴이 일치하지 않을 경우 사용자에게 알려줄 수 있습니다. 예를 들면 툴팁, 보조 기술을 사용해서 해당 콘트롤에 포커스를 이동하는 등의 활용이 가능합니다.</dd>
		</dl>
