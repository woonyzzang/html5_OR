...
<head>
<meta charset="utf-8">
<title>required 속성 (input) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 속성 설명 -->
	<section>
		<h2 class="s_tit">required 속성 (input)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>input 요소에서 사용되는 required 속성은 사용자의 입력이 반드시 필요한 것임을 명시적으로 나타냅니다.</dd>
		</dl>
