...
<head>
<meta charset="utf-8">
<title>http-equiv 속성 (meta) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 속성 설명 -->
	<section>
		<h2 class="s_tit">http-equiv 속성 (meta)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>http-equiv 속성은 meta 요소에서 정의된 명령(사항)을 먼저 실행한 후에 페이지를 로딩합니다. 이를 프라그마 디렉티브(pragma directive)라고 합니다.</dd>
		</dl>
