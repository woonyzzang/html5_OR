...
<head>
<meta charset="utf-8">
<title>disabled 속성 (option) : <?php echo TITLE_REFERENCE; ?></title>
...
Ext.onReady(function(){
	var tplData = {
		...
		txt: 'disabled 속성을 사용하게 되면 그 값이 option 요소의 레이블이 되며, 없다면 요소내의 텍스트가 레이블이 됩니다. 둘 다 제공되는 경우 label 속성의 값이 표시됩니다.'
	};
