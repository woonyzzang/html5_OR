...
<head>
<meta charset="utf-8">
<title>size 속성 (input) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 속성 설명 -->
	<section>
		<h2 class="s_tit">size 속성 (input)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>size 속성은 사용자 에이전트가 그 값을 수정하려는 사용자에게 시각적으로 보여줄 글자 수를 나타냅니다.</dd>
		</dl>

		<h3 class="s_tit">속성 값</h3>
		<p>속성 값은 유효한 양의 정수여야 합니다.</p>
	</section>
	<!-- //속성 설명 -->
	<!-- 샘플 코드 -->
	<section>
