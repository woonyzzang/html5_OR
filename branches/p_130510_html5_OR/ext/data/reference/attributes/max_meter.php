...
<head>
<meta charset="utf-8">
<title>max 속성 (meter) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 속성 설명 -->
	<section>
		<h2 class="s_tit">max 속성 (meter)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>max 속성은 meter 요소의 최대 값을 나타냅니다.</dd>
		</dl>

		<h3 class="s_tit">속성 값</h3>
		<p>유효한 부동소수점 숫자를 사용하여야 합니다. 값을 명시하지 않으면 최소 값은 1이 됩니다.</p>
	</section>
	<!-- //속성 설명 -->
	<!-- 샘플 코드 -->
	<section>
