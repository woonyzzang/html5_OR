...
<head>
<meta charset="utf-8">
<title>readonly 속성 (input) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 태그 설명 -->
	<section>
		<h2 class="s_tit">readonly 속성 (input)</h2>
	...
	<section>
		...
		<pre class="brush:html">
			<p><label>아이디: <input type="text" name="id" value="gildong" readonly="readonly"></label></p>
