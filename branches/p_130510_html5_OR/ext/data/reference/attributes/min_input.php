...
<head>
<meta charset="utf-8">
<title>min 속성 (input) : HTML5 Open Reference Guide</title>
...
<article id="content_desc">
	<!-- 속성 설명 -->
	<section>
		<h2 class="s_tit">min 속성 (input)</h2>

		<dl class="definition">
		<dt>정의</dt>
		<dd>min 속성은 요소에서 허용하는 최소 값을 정의합니다.</dd>
		</dl>

		<h3 class="s_tit">속성 값</h3>
		<p>속성 값은 유효한 국제적 날짜와 시간 문자열이어야 합니다. max 속성의 최대값은 min 속성의 최소값보다 작을 수 없습니다.</p>
	</section>
	<!-- //속성 설명 -->
	<!-- 샘플 코드 -->
	<section>
