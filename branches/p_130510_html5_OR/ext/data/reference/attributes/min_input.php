...
<head>
<meta charset="utf-8">
<title>min 속성 (input) : <?php echo TITLE_REFERENCE; ?></title>
...
Ext.onReady(function(){
	var tplData = {
		...
		meaning: 'input',
		item: [{
			desc:'min 속성은 요소에서 허용하는 최소 값을 정의합니다.'
		}],
		txt: '속성 값은 유효한 국제적 날짜와 시간 문자열이어야 합니다. max 속성의 최대값은 min 속성의 최소값보다 작을 수 없습니다.'
	};
