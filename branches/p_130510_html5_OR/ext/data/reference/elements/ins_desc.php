...
<head>
<meta charset="utf-8">
<title>ins 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>
			<ul>
			<li>플로우 컨텐츠</li>
			<li>요소가 구문 컨텐츠만을 포함한다면 구문 컨텐츠</li>
			</ul>
		</dd>
		<dt>[이 사용될 수 있는요소가 문맥]</dt>
		<dd>요소가 구문 컨텐츠만을 포함한다면 구문 컨텐츠가 올 수 있는 곳</dd>
...
Uses the HTMLModElement interface.
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠에 속하며, 구문 컨텐츠를 포함 하는 경우 구문 컨텐츠에 속합니다.</li>
		<li>구문 컨텐츠만 포함하면 구문 컨텐츠의 위치에 쓸 수 있으며, 포함 하지 않으면 플로우 컨텐츠의 위치에 사용할 수 있습니다.</li>
		<li>투명한 내용를 자식 요소로 포함할 수 있습니다.</li>
		<li>ins 요소는 문단에 영향을 미치지 않습니다.</li>
		<li>ins 요소는 암시적인 문단 경계를 가로질러서는 안 됩니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>기본적으로 모든 브라우저 해당 텍스트부분에 underline(밑줄)이 나타납니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
