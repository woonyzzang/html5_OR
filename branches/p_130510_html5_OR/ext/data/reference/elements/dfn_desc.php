...
<head>
<meta charset="utf-8">
<title>dfn 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>구문 컨텐츠. 하지만 dfn 요소는 포함할 수 없습니다.</dd>
		<dt>[요소에 사용할 수 있는 속성]</dt>
		<dd>
			<ul>
			<li>Global attributes</li>
			<li>또한, title 속성은 이 요소에서 특별한 의미를 가집니다.</li>
			</ul>
		</dd>
		<dt>[DOM 인터페이스]</dt>
		<dd>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<li>구문 컨텐츠의 위치에서 사용됩니다.</li>
		<li>dfn 요소를 제외한 구문 컨텐츠를 자식 요소로 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>HTML5에서 title 속성이 재정의 되었습니다.</li>
