...
<head>
<meta charset="utf-8">
<title>sub&frasl;sup 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Use HTMLElement.
	...
	<section id="flow">
		...
		<li>aside 요소는 구문 컨텐츠가 사용될 수 있는 곳에서 사용할 수 있습니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>sub 요소의 첨자 텍스트는 기준선 아래의 절반정도 위치에 문자로 브라우저에 렌더링 됩니다.</li>
		<li>sup 요소의 첨자 텍스트는 기준선 위의 절반정도 위치에 문자로 브라우저에 렌더링 됩니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
