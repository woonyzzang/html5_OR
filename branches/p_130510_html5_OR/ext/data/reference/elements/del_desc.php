...
<head>
<meta charset="utf-8">
<title>del 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses the HTMLModElement interface.
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠에 속하며, 구문 컨텐츠를 포함할 때는 구문 컨텐츠에 속합니다.</li>
		<li>구문 컨텐츠만 포함하면 구문 컨텐츠의 위치에 사용할 수 있으며, 포함 하지 않을 경우 플로우 컨텐츠의 위치에 사용할 수 있습니다.</li>
		<li>투명한 내용를 자식 요소로 포함할 수 있습니다.</li>
		<li>del 요소는 문단에 영향을 미치지 않습니다.</li>
		<li>del 요소는 암시적인 문단 경계를 가로질러서는 안됩니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>대화를 dd 요소로 마크업하는 것은 권장하지 않습니다. 대화에는 p 요소 사용을 권장합니다.</li>
		<li>기본적으로 모든 브라우저에 삭제되었음을 보여주는 선이 텍스트 가운데로 렌더링 됩니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
