...
<head>
<meta charset="utf-8">
<title>header 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<li>header 요소나 footer 요소를 제외한 플로우 컨텐츠를 자식 요소로 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>header 요소는 제목 요소를 포함하지 않아도 됩니다. 섹션의 차례나 검색 폼, 관련 로고 등을 감싸는 용도로도 사용할 수 있습니다.</li>
		<li>header 요소는 섹션 컨텐츠는 아닙니다.</li>
