...
<head>
<meta charset="utf-8">
<title>optgroup 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLOptGroupElement : HTMLElement {
	...
	<section id="flow">
		...
		<ul>
		<li>select 요소의 자식 요소로 씁니다.</li>
		<li>자식 요소로 option 요소를 포함할 수 있습니다.</li>
		<li>label 속성은 반드시 사용해야 합니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>optgroup 요소는 option 요소만을 포함할 수 있습니다.</li>
		<li>optgroup으로 만든 그룹은 중첩하여(nested) 사용할 수 없습니다.</li>
		<li>IE6 에서는 label 속성을 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
