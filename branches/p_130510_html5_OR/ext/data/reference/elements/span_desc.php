...
<head>
<meta charset="utf-8">
<title>span 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLSpanElement : HTMLElement {};
	...
	<section id="flow">
		...
		<li>구문 컨텐츠가 사용될 수 있는 곳에 올 수 있습니다.</li>
	...
	<section id="memo">
		...
		<ul>
		<li>span 요소는 문서의 그룹 인라인 요소로 사용됩니다.</li>
		<li>이 요소는 그 자체로 시각적인 변화를 제공하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
