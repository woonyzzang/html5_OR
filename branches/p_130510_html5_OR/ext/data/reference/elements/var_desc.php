...
<head>
<meta charset="utf-8">
<title>var 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<li>또한, 자식 요소로 구문 컨텐츠를 포함할 수 있습니다.</li>
		<li>수학을 표현하려면 아주 간단한 표현식이 아닌 한 var 요소보다는 MathML이 적합합니다. 그러한 MathML 표현식에서 언급된 특정 변수를 참조할 때 var 요소를 사용할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
