...
<head>
<meta charset="utf-8">
<title>b 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="memo">
		...
		<ul>
		<li>b 요소는 의미보다는 꾸미는 성격이 강해서 HTML4&frasl;XHTML1 명세에서 폐기했지만, 이미 널리 쓰이므로 적합한 의미를 부여해서 HTML5 명세에서 부활시켰습니다.</li>
		<li>b 요소에는 그 내용이 중요하다는 의미는 전혀 없습니다. 요소의 내용이 중요할때는 strong 요소, 요소의 내용을 강조할 때는 em 요소를 씁니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
