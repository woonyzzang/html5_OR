...
<head>
<meta charset="utf-8">
<title>ul 요소 상세설명 : HTML5 Open Reference Guide</title>
...
interface HTMLUListElement : HTMLElement {};
	...
	<section id="flow">
		...
		<ul>
		<li>플로우 컨텐츠에 속합니다.</li>
		<li>플로우 컨텐츠가 올 수 있는 곳에서 사용할 수 있습니다.</li>
		<li>자식 요소에는 0개 이상의 li 요소만을 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>compact 속성, type 속성은 폐기deprecated된 속성입니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
