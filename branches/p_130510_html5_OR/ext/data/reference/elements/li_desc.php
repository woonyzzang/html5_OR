...
<head>
<meta charset="utf-8">
<title>li 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>
			...
			<li>ol 요소의 내부에서 사용되었을 경우: value</li>
			</ul>
		</dd>
		<dt>[DOM 인터페이스]</dt>
		<dd>
...
interface HTMLLIElement : HTMLElement {
	...
	<section id="memo">
		...
		<ul>
		<li>type 속성은 HTML 4.01에서 사용되지되었고, HTML5에서 지원되지 않습니다.</li>
		<li>value 속성은 HTML 4.01 이후 폐기된 속성이지만, HTML5에서는 목록의 순서 번호를 임의로 변경할 수 있는 용도로 사용할 수 있도록 변경되었습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
