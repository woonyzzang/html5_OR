...
<head>
<meta charset="utf-8">
<title>ruby 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>다음 중 하나 이상: 구문 컨텐츠와 그 뒤에 따라오는 rt 또는 rp 요소, 또는 rp 요소, 또는 rt 요소와 그와 다른 rp 요소.</dd>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<ul>
		<li>구문 컨텐츠와 플로우 컨텐츠에 속합니다.</li>
		<li>구문 컨텐츠가 사용될 수 있는 곳에 ruby 요소를 사용할 수 있습니다.</li>
		<li>하나 이상의 rt 요소 또는 rp 요소를 포함할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>일본에서는 &#34;후리가나&#34;라고 한자 읽는 법을 표기합니다.</li>
		<li>IE8 및 이전 버전, rp 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
