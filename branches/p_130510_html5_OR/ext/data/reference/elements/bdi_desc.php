...
<head>
<meta charset="utf-8">
<title>bdi 요소 상세설명 : <?php echo TITLE_REFERENCE; ?></title>
...
<article>
	...
	<section id="refer">
		...
		<dd>
			...
			<li>또한, 전역 속성 dir은 이 요소에서 특별한 의미를 갖습니다.</li>
			</ul>
		</dd>
		<dt>[DOM 인터페이스]</dt>
		<dd>
...
Uses HTMLElement.
	...
	<section id="memo">
		...
		<ul>
		<li>브라우저가 텍스트를 보고 자동으로 방향성을 판단하기 때문에 사용자가 입력하는 언어를 모를 때 유용할 수 있습니다.</li>
		<li>그러나 방향성을 판단하는 알고리즘이 조악해서 버그가 있을 수 있으니 주의해서 써야 합니다. 오른쪽에서 왼쪽으로 쓰는 언어를 정확히 판단할 방법이 없습니다.</li>
		<li>IE, Opera, Safari에서 bdi 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
	...
	<section id="browser">
		...
		<p>
			...
			<img src="<?php echo PATH; ?>resources/css/images/custom/ico_support_ie7_none.png" width="25" height="25" alt="IE7 지원 인함">
