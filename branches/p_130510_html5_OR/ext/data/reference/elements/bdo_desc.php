...
<head>
<meta charset="utf-8">
<title>bdo 요소 상세설명 : HTML5 Open Reference Guide</title>
...
Uses HTMLElement.
	...
	<section id="memo">
		...
		<ul>
		<li>bdi 요소는 텍스트 내용을 보고 방향을 결정합니다. 즉 오른쪽에서 왼쪽으로 쓰는 언어인 히브리어를 bdi 요소로 둘러싸면 브라우저는 그 문자를 인식하고 '자동으로' 오른쪽에서 왼쪽으로 씁니다. 따라서 bdi 요소에는 dir 속성을 명시하지 않습니다.</li>
		<li>이에 반해 bdo 요소는 작성자가 강제로 텍스트의 방향을 결정합니다. 즉 이 요소에는 반드시 dir 속성을 써 주어야 합니다. 쓰지 않으면 다음처럼 유효성 검사에 걸립니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
