...
<head>
<meta charset="utf-8">
<title>figcaption 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>figure 요소의 첫 번째 혹은 마지막 자식 요소</dd>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<ul>
		<li>figure 요소의 첫번째 또는 마지막 요소로 나타날 수 있습니다.</li>
	...
	<section id="memo">
		...
		<li>IE8 및 이전 버전, figcaption 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
