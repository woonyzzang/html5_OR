...
<head>
<meta charset="utf-8">
<title>head 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>HTML 요소의 첫 번째 요소로.</dd>
		<dt>[이 요소가 포함할 수 있는 것]</dt>
		<dd>이 문서는 iframe을 srcdoc 문서입니다 또는 제목 정보를 높은 수준의 프로토콜에서 사용할 수있는 경우 경우 메타 데이터 내용의 0 개 이상의 요소입니다.</dd>
		<dd>아니라면: 정확히 하나의 title 요소가되는 메타 데이터의 내용 중 하나 이상의 요소.</dd>
...
interface HTMLHeadElement : HTMLElement {};
	...
	<section id="flow">
		...
		<ul>
		<li>html 요소 내부의 첫 번째 요소로 사용됩니다.</li>
		<li>자식 요소로 올 수 있는 것은 0개 이상의 메타데이터이고 그 중 반드시 하나는 title 요소여야 하지만 문서가 iframe srcdoc 문서이거나 상위 레벨의 프로토콜로부터 타이틀 정보를 상속받았으면 title 요소를 생략할 수 있습니다.</li>
		<li>head 요소 내부의 메타데이터 집합은 클 수도, 작을 수도 있습니다.</li>
		<li>대부분 title 요소를 포함해야 하지만 HTML로 쓴 이메일의 제목 줄처럼 상위 레벨의 프로토콜에서 타이틀 정보를 얻을 수 있을 때는 생략할 수 있습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<ul>
		<li>HTML5에서 profile 속성이 폐기되었습니다.</li>
		<li>모든 헤드 요소에 대한 컨테이너 입니다.</li>
		<li>문서의 제목을 포함해야하며, script, style, meta 정보 등을 포함 할 수 있습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
