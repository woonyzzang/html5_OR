...
<head>
<meta charset="utf-8">
<title>progress 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>구문 컨텐츠. 하지만 progress 요소를 자손으로 가질 수는 없습니다.</dd>
...
interface HTMLProgressElement : HTMLElement {
  ...
  readonly attribute NodeList labels;
	...
	<section id="flow">
		...
		<li>자식 요소로 자신을 제외한 구문 컨텐츠를 포함할 수 있습니다.</li>
		<li>현재의 값과 최대값을 요소 내부에 인라인으로도 역시 포함시켜서, 구형 사용자 에이전트의 사용자들도 진척도를 알 수 있게 하기를 권합니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>하드 디스크의 남은 공간 표시같은 게이지를 나타낼 때는 progress 요소보다는 meter 요소가 더 적절합니다.</li>
		<li>IE9 및 이전 버전, progress 요소를 지원하지 않습니다.</li>
		</ul>
	</section>
	<!--//참조 -->
	<!-- 관련 요소 레벨 -->
