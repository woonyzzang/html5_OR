...
<head>
<meta charset="utf-8">
<title>rp 요소 상세설명 : HTML5 Open Reference Guide</title>
...
<article>
	...
	<section id="refer">
		...
		<dd>ruby 요소의 자손이며, rt 요소의 바로 앞 혹은 바로 뒤에 나타날 수 있습니다.</dd>
...
Uses HTMLElement.
	...
	<section id="flow">
		...
		<ul>
		<li>ruby 요소의 자식 요소이며, rt 요소의 바로 앞 또는 바로 뒤에 나타날 수 있습니다.</li>
		<li>구문 컨텐츠를 포함할 수 있습니다.</li>
		<li>rp 요소는 아무것도 표현하지 않습니다.</li>
		</ul>
	</section>
	<!-- //콘텐츠 분류 타입 -->
	<!-- 참조 -->
	<section id="memo">
		...
		<li>rp요소는 ruby요소의 자식 요소로 사용됩니다.</li>
